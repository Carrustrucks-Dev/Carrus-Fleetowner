...
import com.carrus.fleetowner.BookingDetailsActivity;
...
//        holder.mTextView.setText(mDataset[position
        if (holder instanceof ViewHolder) {
            ...
            try {
                ((ViewHolder) holder).mTimeTxtView.setText(Utils.getDay(myList.get(position).pickUp.date) + mActivity.getResources().getString(R.string.comma_spraction) + myList.get(position).pickUp.time);
            } catch (ParseException e) {
                e.printStackTrace();
            }
