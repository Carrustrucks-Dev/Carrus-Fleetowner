...
public class TruckQuotesListAdapter extends RecyclerView.Adapter {
    ...
    public TruckQuotesListAdapter(Activity mActivity) {
        this.mActivity = mActivity;
    }

    // Provide a suitable constructor (depends on the kind of dataset)
    public TruckQuotesListAdapter(Activity mActivity, List<TruckQuotesDetails> myList, RecyclerView recyclerView) {
        this.mActivity = mActivity;
        this.myList = myList;
...
//        holder.mTextView.setText(mDataset[position
        if (holder instanceof ViewHolder) {
            ((ViewHolder) holder).mOfferedBidLayout.setVisibility(View.VISIBLE);
            try {
