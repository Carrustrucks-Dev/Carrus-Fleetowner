...
import com.carrus.fleetowner.LoginActivity;
...
//        driverRating.setRating(Float.valueOf(sharedPreferences.getString(RATING, "0")));
    ...
    public void saveUserInfo(String accesstoken, String usertype, String email, String name, String comapnyName, String address, String phone, String profilePic) {
...
//        editor.putString(KEY_RATING, rating);
        ...
        editor.putString(KEY_COMPANY_TYPE, "");
