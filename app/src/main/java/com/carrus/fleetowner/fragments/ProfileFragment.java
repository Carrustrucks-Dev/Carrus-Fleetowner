...
public class ProfileFragment extends Fragment implements
    ...
    private void setData() {
        ...
        if (mSessionManager.getProfilePic() != null && !mSessionManager.getProfilePic().isEmpty())
            Picasso.with(getActivity()).load(mSessionManager.getProfilePic()).placeholder(R.mipmap.icon_placeholder).error(R.mipmap.icon_placeholder).resize((int)Utils.convertDpToPixel(120, getActivity()), (int)Utils.convertDpToPixel(120, getActivity())).transform(new CircleTransform()).into(driverImage);
                ...
                try {
                    ...
                    if (ApiResponseFlags.OK.getOrdinal() == status) {
                        ...
                        if (mSessionManager.getProfilePic() != null)
                            Picasso.with(getActivity()).load(mSessionManager.getProfilePic()).placeholder(R.mipmap.icon_placeholder).resize((int)Utils.convertDpToPixel(120, getActivity()), (int)Utils.convertDpToPixel(120, getActivity())).transform(new CircleTransform()).into(driverImage, new com.squareup.picasso.Callback() {
                                @Override
