 ...
 */
public class TruckAssignFragment extends Fragment {
     ...
     */
    public static TruckAssignFragment newInstance(int index) {
        TruckAssignFragment f = new TruckAssignFragment();
...
//                Color.RED, Color.GREEN, Color.BLUE, Color.CYAN);
    ...
    private void getMyBooking() {
        ...
        RestClient.getApiService().getPendingAssignment(mSessionManager.getAccessToken(), LIMIT + "", skip + "", SORT, new Callback<String>() {
